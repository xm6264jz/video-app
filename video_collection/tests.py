...
class TestAddVideos(TestCase):
    ...
    def test_add_duplicate_video_not_added(self):
        ...
        with transaction.atomic():
            ...
            self.assertIn('You have already added that video', message_texts)

            self.assertContains(response, 'You have already added that video')  # and message displayed on page 
